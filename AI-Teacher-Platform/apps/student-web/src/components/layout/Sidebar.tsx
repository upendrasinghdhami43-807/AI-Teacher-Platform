...
import { Home, Bot, FileText, BookOpen, Users, BarChart3, User, Settings, X, Sparkles } from 'lucide-react';
...
const navGroups: { label: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { to: '/pdf-learn', icon: FileText, label: 'PDF Learn' },
  ...
  },
  {
    label: 'DISCOVER',
    items: [
      { to: '/personas', icon: Users, label: 'Personas', comingSoon: true },
      { to: '/progress', icon: BarChart3, label: 'My Progress', comingSoon: true },
    ],
  },
  {
    label: 'ACCOUNT',

...
class Settings(BaseSettings):
    ...
    # Stage 2B: 3-Model Pipeline
    AI_DECISION_MODEL: str = "gemini-2.5-flash-lite"
    AI_DECISION_MODEL_FALLBACK: str = "llama-3.1-8b-instant"
    AI_SCRIPT_MODEL: str = "gemini-2.5-flash"
    AI_BOARD_MODEL: str = "gemini-2.5-flash-lite"
    LESSON_MAX_DURATION_SECONDS: int = 300
    LESSON_SPEAKING_RATE_WPM: int = 140
